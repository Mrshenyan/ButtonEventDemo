import { IProtocolHelper, NetData } from "./IProtocolHelper";

import { RequestObject, CallbackObject, NetCallFunc, ISocket, INetworkTips } from "./NetInterface";
...
type CheckFunc = (CheckFunc:VoidFunc)=>void;
type VoidFunc = ()=>void;
...
export class NetNode {
    ...
    protected initSocket() {
        ...
        this._socket.onClose = (event) => { this.onClosed(event) };
